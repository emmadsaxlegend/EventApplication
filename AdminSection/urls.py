...
from . import views
from .views import FreeView, FreeEventDetailsView,FreeEventView,PaidEventView, UpdateEventView, DeleteEventView
...
urlpatterns = [
    ...
    path("", FreeView.as_view(), name="free_events_page"),
